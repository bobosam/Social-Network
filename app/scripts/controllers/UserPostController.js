app.controller('UserPostController', function PostController($scope,
                                                             $document,
                                                             $modal,
                                                             authentication,
                                                             postsData,
    ...
    userData.getUserPreviewData($scope.post.author.username)
        .then(
    ...
    $scope.likePost = function () {
        ...
        postsData.likePostById($scope.post.id)
            ...
            function successHandler(data) {
                ...
                postsData.getsPostPreviewLikes($scope.post.id)
                    .then(
    ...
    $scope.unlikePost = function () {
        ...
        postsData.unlikePost($scope.post.id)
            .then(
            function successHandler(data) {
